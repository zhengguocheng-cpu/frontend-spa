...
**修复方案**：
- ✅ **已采用方案 A**：修改 BiddingControls 样式，改回水平布局
- 修改文件：`src/games/doudizhu/components/BiddingControls/style.css`
- 修改内容：`flex-direction: column` → `flex-direction: row`
